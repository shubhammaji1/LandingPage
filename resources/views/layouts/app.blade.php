...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/capacity_building_section.css') }}">
    <script src="{{asset('js/capacityBuilding.js')}}"></script>
    <link rel="stylesheet" href="{{ asset('css/overview_section.css') }}">
    <link rel="stylesheet" href="{{ asset('css/donation_section.css') }}">
    <link rel="stylesheet" href="{{ asset('css/partners_and_clients.css') }}">
